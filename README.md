...
### **🤖 AI 파트너십 과정**
 ...
 2. **내용 2 : 로드맵 도출**
    * **프롬프트 요약:** "시스템 구현과 과제의 요구 조건을 충족하기 위한 필요 기능 논의"
    * **적용 내용:** 시스템 구현에 필요한 기능과 과제 요구 조건을 매칭시켜 로드맵을 도출함
   
 3. **내용 3 : 레이팅 관련 논의**
    * **프롬프트 요약:** "ntrp와 elo레이팅 선택 논의"
    * **적용 내용:** 실용적인 시스템의 완성을 위해 elo레이팅 사용 결정
    
### **📁 증빙 자료:**
  * [1차_AI협업캡처.pdf 첨부 완료] 1차_AI협업챕처.pdf
