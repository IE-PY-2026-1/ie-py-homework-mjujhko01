...
### **🤖 AI 파트너십 과정**
 1. **내용 1 : 주제 결정**
    ...
    * **적용 내용:** AI가 추천한 세가지 주제가 마음에 들지 않아 원래 생각했던 주제인 테니스 클럽 관리 시스템으로 결정함
 ...
 3. **내용 3 : 레이팅 관련 논의**
    ...
    * **적용 내용:** 실용적인 시스템의 완성을 위해 elo레이팅 채택을 결정함
    
### **📁 증빙 자료:**
  * [1차_AI협업캡처.pdf 첨부 완료]
  * [1차_AI협업챕처.pdf](https://github.com/IE-PY-2026-1/ie-py-homework-mjujhko01/blob/main/1차_AI협업챕처.pdf)
